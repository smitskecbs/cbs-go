(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function n(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(r){if(r.ep)return;r.ep=!0;const i=n(r);fetch(r.href,i)}})();const ke="modulepreload",Me=function(e){return"/cbs-go/"+e},U={},Ee=function(t,n,o){let r=Promise.resolve();if(n&&n.length>0){let g=function(l){return Promise.all(l.map(u=>Promise.resolve(u).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))};var s=g;document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),d=a?.nonce||a?.getAttribute("nonce");r=g(n.map(l=>{if(l=Me(l),l in U)return;U[l]=!0;const u=l.endsWith(".css"),f=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${f}`))return;const p=document.createElement("link");if(p.rel=u?"stylesheet":ke,u||(p.as="script"),p.crossOrigin="",p.href=l,d&&p.setAttribute("nonce",d),document.head.appendChild(p),u)return new Promise((M,b)=>{p.addEventListener("load",M),p.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${l}`)))})}))}function i(a){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=a,window.dispatchEvent(d),!d.defaultPrevented)throw a}return r.then(a=>{for(const d of a||[])d.status==="rejected"&&i(d.reason);return t().catch(i)})},Le=[{id:"node-1",type:"puzzle",name:"Signal vs Noise",description:"Logic puzzle (2 min).",xp:60,puzzle:{type:"mcq",q:`A scammer always lies. A builder always tells the truth.
...
(Each letter is shifted +1 from the original.)`,hint:"Try shifting letters back by 1.",code:"CAS",explain:"DBT shifted back by 1 → CAS."}},{id:"node-4",type:"puzzle",name:"Steps Math",description:"Quick math check.",xp:50,puzzle:{type:"input",q:"If you walk 2 km and your step length is 0.8 m, about how many steps is that? (Round to whole number)",answers:["2500"],explain:"2000m / 0.8m ≈ 2500 steps."}},{id:"node-5",type:"puzzle",name:"CBS Motto",description:"Community memory.",xp:30,puzzle:{type:"code",q:"Type the CBS motto (3 words):",hint:"C _ _ _ _ _ _ _  B _ _ _ _ _  S _ _ _ _ _ _ _ _ _",code:"COMMUNITY BUILDS SOVEREIGNTY",explain:"CBS = Community Builds Sovereignty."}}],oe="cbsgo_state_v6";function ze(e,t){try{const n=JSON.parse(e);return n&&typeof n=="object"?n:t}catch{return t}}function Ce(){return{xp:0,completed:{},updatedAt:Date.now()}}function _(){const e=localStorage.getItem(oe);return ze(e,Ce())}function re(e){e.updatedAt=Date.now(),localStorage.setItem(oe,JSON.stringify(e))}function ie(e){return 100+(Math.max(1,Number(e||1))-1)*40}function A(){return Number(_().xp||0)}function j(){const e=A();let t=1,n=e;for(;;){const o=ie(t);if(n<o||(n-=o,t+=1,t>999))break}return t}function se(){const e=A();let t=1,n=e;for(;;){const o=ie(t);if(n<o||(n-=o,t+=1,t>999))break}return n}function I(e){const t=Number(e||0);if(!Number.isFinite(t)||t<=0)return _();const n=_();return n.xp=Number(n.xp||0)+t,re(n),window.dispatchEvent(new CustomEvent("cbsgo:xpChanged",{detail:{xp:n.xp,level:j()}})),n}function ae(e){const t=String(e||"");if(!t)return!1;const n=_();return!!(n.completed&&n.completed[t])}function de(e){const t=String(e||"");if(!t)return;const n=_();n.completed||(n.completed={}),n.completed[t]=Date.now(),re(n),window.dispatchEvent(new CustomEvent("cbsgo:nodeCompleted",{detail:{id:t}}))}const Pe=Object.freeze(Object.defineProperty({__proto__:null,addXp:I,completeNode:de,getLevel:j,getXp:A,getXpIntoLevel:se,isNodeCompleted:ae},Symbol.toStringTag,{value:"Module"})),ce="cbsgoPuzzleModal";function K(e){return String(e||"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function X(){const e=document.getElementById(ce);e&&e.remove()}function V(e){X();const t=document.createElement("div");t.id=ce,t.style.position="fixed",t.style.inset="0",t.style.zIndex="999999",t.style.display="flex",t.style.alignItems="center",t.style.justifyContent="center",t.style.padding="16px",t.style.background="rgba(0,0,0,.70)",t.style.backdropFilter="blur(12px)",t.style.fontFamily="system-ui, sans-serif",t.style.color="#fff";const n=e?.name||"CBS GO Puzzle",o="Puzzels komen later terug. Voor nu focussen we op lopen, XP en tickets.";t.innerHTML=`
  ...
  `,document.body.appendChild(t);const r=document.getElementById("cbsgoPuzzleClose"),i=document.getElementById("cbsgoPuzzleOk"),s=()=>{X()};r&&(r.onclick=s),i&&(i.onclick=()=>{try{e?.id&&de(e.id),I(5)}catch{}s()})}function J(e,t,n){const o=Number(e||0);return Number.isFinite(o)?Math.max(t,Math.min(n,o)):t}function q(){const e=Number(A()||0),t=Number(j()||1),n=Number(se()||0),o=J(n,0,100),r=J(o/100*100,0,100);return`
  ...
  `}function Ne(){if(typeof window>"u"||window.__cbsgo_xp_rerender_bound)return;window.__cbsgo_xp_rerender_bound=!0;const e=()=>{const t=document.querySelector("#xpMount");t&&(t.innerHTML=q())};window.addEventListener("cbsgo:xpChanged",e),window.addEventListener("cbsgo:stepsChanged",e),window.addEventListener("cbsgo:inventoryChanged",e),setInterval(e,1e3)}Ne();const le="cbsgo_inventory_v1";function Ae(e,t){try{const n=JSON.parse(e);return n&&typeof n=="object"?n:t}catch{return t}}function Ie(){return{tickets:0}}function D(){const e=localStorage.getItem(le);return Ae(e,Ie())}function Te(e){localStorage.setItem(le,JSON.stringify(e))}function ue(){return Number(D().tickets||0)}function F(e=1){const t=Number(e||0);if(!Number.isFinite(t)||t<=0)return D();const n=D();return n.tickets=Number(n.tickets||0)+t,Te(n),window.dispatchEvent(new CustomEvent("cbsgo:inventoryChanged",{detail:{...n}})),n}const pe="cbsgo_steps_v6",$e="cbsgo_gps_autostart_v2",fe="cbsgo_daily_puzzle_v1",Be=.75,De=200,Oe=.3,Re=400,je=20,$=1500,B=200,qe=.25,Fe=.05,He=.3;let E=null,L=!1,m={msg:"init"};function Ge(e,t){try{const n=JSON.parse(e);return n&&typeof n=="object"?n:t}catch{return t}}function We(){return{steps:0,meters:0,lastPos:null,rewarded5k:!1,rewarded10k:!1,boostUntil:0,boostLastStep:0,chestMeters:0,updatedAt:Date.now()}}function S(){const e=localStorage.getItem(pe);return Ge(e,We())}function ge(e){e.updatedAt=Date.now(),localStorage.setItem(pe,JSON.stringify(e))}function z(){return Number(S().steps||0)}function P(){return!!L}function Ye(){return m}function H(){const e=new Date,t=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${t}-${n}-${o}`}function Ue(){try{return localStorage.getItem(fe)===H()}catch{return!1}}function Ke(){try{localStorage.setItem(fe,H())}catch{}}function Xe(e,t){return Ue()?!1:(window.dispatchEvent(new CustomEvent("cbsgo:dailyPuzzle",{detail:{lat:e,lng:t,date:H()}})),Ke(),!0)}function Z(){const e=S(),t=Number(e.boostUntil||0);return Math.max(0,t-Date.now())}function Ve(e){if(!Math.max(0,Number(e.boostUntil||0)-Date.now()))return;const n=Number(e.boostLastStep||0),o=Number(e.steps||0);if(!Number.isFinite(n)){e.boostLastStep=o;return}const r=o-n;if(!Number.isFinite(r)||r<$)return;const i=Math.floor(r/$);i<=0||(F(i),e.boostLastStep=n+i*$)}function Je(e){let t=Number(e.chestMeters||0);if(Number.isFinite(t)||(t=0),t<B){e.chestMeters=t;return}let n=0;for(;t>=B&&n<5;)if(t-=B,n+=1,Math.random()<qe){const o=Math.random()<Fe,r=o?10:3,i=o?2:1;I(r),F(i);const s=o&&Math.random()<He;window.dispatchEvent(new CustomEvent("cbsgo:treasureFound",{detail:{xp:r,tickets:i,rare:o,hasCBSFlag:s}}));break}e.chestMeters=t}function Ze(e,t){const o=g=>g*Math.PI/180,r=o(t.lat-e.lat),i=o(t.lng-e.lng),s=o(e.lat),a=o(t.lat),d=Math.sin(r/2)**2+Math.cos(s)*Math.cos(a)*Math.sin(i/2)**2;return 2*6371e3*Math.asin(Math.sqrt(d))}function Qe(e){!e.rewarded5k&&e.steps>=5e3&&(e.rewarded5k=!0,I(20)),!e.rewarded10k&&e.steps>=1e4&&(e.rewarded10k=!0,F(1))}function et(e){const t=Number(e||0);if(!Number.isFinite(t)||t<=0)return S();const n=S();n.meters=Number(n.meters||0)+t,n.chestMeters=Number(n.chestMeters||0)+t;const o=Math.floor((n.meters||0)/Be);return o>n.steps&&(n.steps=o),Qe(n),Ve(n),Je(n),ge(n),window.dispatchEvent(new CustomEvent("cbsgo:stepsChanged",{detail:{steps:n.steps}})),n}function tt(){E!=null&&navigator.geolocation&&navigator.geolocation.clearWatch(E),E=null}async function Q(e={}){const t=!!e.silent;if(!navigator.geolocation)return m={err:"GPS not supported",t:Date.now()},{ok:!1,reason:"GPS not supported"};try{localStorage.setItem($e,"1")}catch{}tt(),L=!0,m={msg:"requesting",t:Date.now()};try{return E=navigator.geolocation.watchPosition(n=>{const o=n.coords.latitude,r=n.coords.longitude,i=n.coords.accuracy||999,s=Date.now(),a=S(),d=a.lastPos;a.lastPos={lat:o,lng:r,t:s},ge(a);const g=Number.isFinite(n.coords.heading)?n.coords.heading:null,l=Number.isFinite(n.coords.speed)?n.coords.speed:null;if(window.dispatchEvent(new CustomEvent("cbsgo:playerPos",{detail:{lat:o,lng:r,acc:i,heading:g,speed:l,t:s}})),i>De){m={lat:o,lng:r,acc:i,t:s,reason:"accuracy",boostMs:Z()},window.dispatchEvent(new CustomEvent("cbsgo:stepsChanged",{detail:{steps:z()}}));return}Xe(o,r);let u=0,f=0,p=0,M=0,b="no-last";d&&typeof d.lat=="number"&&typeof d.lng=="number"&&typeof d.t=="number"&&(u=Ze({lat:d.lat,lng:d.lng},{lat:o,lng:r}),f=Math.max(1,(s-d.t)/1e3),p=u/f,u<Oe?b="jitter":u>Re?b="teleport":p>je?b="too-fast":(et(u),M=u,b="ok")),m={lat:o,lng:r,acc:i,t:s,dist:Math.round(u),dt:Math.round(f),speed:Number(p.toFixed(2)),added:Math.round(M),reason:b,boostMs:Z()},window.dispatchEvent(new CustomEvent("cbsgo:stepsChanged",{detail:{steps:z()}}))},n=>{L=!1,m={err:n?.message||"GPS blocked",t:Date.now()},window.dispatchEvent(new CustomEvent("cbsgo:stepsChanged",{detail:{steps:z()}}))},{enableHighAccuracy:!0,maximumAge:1e3,timeout:12e3}),{ok:!0}}catch(n){return L=!1,m={err:String(n?.message||n),t:Date.now()},{ok:!1,reason:"Failed to start GPS"}}}function nt(){if(window.__cbsgo_try_autostart)return;window.__cbsgo_try_autostart=!0,(async()=>P()||await Q({silent:!0}))();const t=async()=>{P()||await Q({silent:!0}),window.removeEventListener("pointerdown",t),window.removeEventListener("touchstart",t),window.removeEventListener("click",t)};window.addEventListener("pointerdown",t,{once:!0}),window.addEventListener("touchstart",t,{once:!0}),window.addEventListener("click",t,{once:!0})}function ot(){const e=Ye();return e?.err?"🔴":e?.lat&&P()?"🟢":P()?"🟡":"⚪"}function G(){const e=z(),t=ue();return`
    <div style="
      margin-top:88px;
      padding:8px 10px;
      border-radius:14px;
...
Reward: ${d.text}`;alert(g);const l={kind:r,...d};try{window.dispatchEvent(new CustomEvent("cbsgo:lootReward",{detail:l}))}catch{}}),a.addTo(y),O=t}function Mt(){return`
  ...
  `}function Et(){try{c&&(c.remove(),c=null,w=null,Y=null,dt=null,y=null,x=null,C=!1,O=0)}catch{}}function Lt(){const e=window.L,t=v("cbsgoMap");if(!e||!t)return!1;Et();const n=e.latLngBounds(e.latLng(-85,-180),e.latLng(85,180));return c=e.map(t,{zoomControl:!1,attributionControl:!1,worldCopyJump:!0,maxBounds:n,maxBoundsViscosity:1,minZoom:1,maxZoom:19}),e.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19,noWrap:!0,bounds:n}).addTo(c),c.setView([51.687,4.87],16),Y=e.layerGroup().addTo(c),y=e.layerGroup().addTo(c),!0}function zt(e){const t=window.L;if(!t||!c)return;const n=xt(t);if(!w){w=t.marker(e,{icon:n}).addTo(c),c.setView(e,18);return}w.setIcon(n),w.setLatLng(e)}function Ct(e){yt(ct,e)}window.__cbsgo_daily_marker_listener_v1||(window.__cbsgo_daily_marker_listener_v1=!0,window.addEventListener("cbsgo:dailyPuzzle",e=>{const t=e?.detail||{};!t.lat||!t.lng||(Ct({date:mt(),shown:!0}),c&&window.L&&Y&&(t.lat,t.lng,void 0))}));function Pt(){!navigator.geolocation||!c||!window.L||navigator.geolocation.watchPosition(e=>{const{latitude:t,longitude:n,accuracy:o}=e.coords,r={lat:t,lng:n};x=[t,n],zt([t,n]),kt(r),h(`GPS OK • accuracy ~${Math.round(o)}m`)},e=>{h(`GPS error: ${e?.message||e?.code||"unknown"}`)},{enableHighAccuracy:!0,maximumAge:0,timeout:2e4})}function Nt(){let e=0;const t=120,n=()=>{if(e++,!v("cbsgoMap"))return e<t?setTimeout(n,100):void 0;if(!window.L){if(h("Loading map engine…"),e<t)return setTimeout(n,100);h("Map engine failed to load (Leaflet not found). Refresh.");return}if(!Lt()){h("Could not init map. Refresh.");return}const r=v("cbsgoCenterBtn");r&&(r.onclick=()=>{c&&x&&c.setView(x,18)});const i=v("cbsgoCompassBtn");i&&(i.onclick=()=>{c&&(C=!C,C?c.setView([51.687,4.87],3):x&&c.setView(x,16))}),h("Loading GPS…"),Pt()};n()}function he(e){return String(e||"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function At(e,t=30){const n=e?`background-image:url('${e}');`:"";return`
    <div style="
      ...
      font-size:16px;
    ">${e?"":"👤"}</div>
  `}function T(){try{return sessionStorage.getItem("cbsgo_selected_tab_v5")||"map"}catch{return"map"}}function R(e){try{sessionStorage.setItem("cbsgo_selected_tab_v5",e)}catch{}}function te(e,t){return`
    <div style="
      position:fixed;
      left:0; right:0;
      bottom:0;
  ...
  `}function Tt(){const e=document.querySelector("#profileName"),t=document.querySelector("#profileAvatar"),n=document.querySelector("#profileRemoveAvatar");let o=null;const r=s=>{const a=document.querySelector("#profileMsg");a&&(a.textContent=s||"")};e&&r(e.value?`✅ Profile loaded: ${e.value}`:"");const i=()=>{if(!e)return;const s=it(e.value);r(`✅ Name saved: ${s}`)};e&&(e.addEventListener("input",()=>{r("Saving…"),o&&clearTimeout(o),o=setTimeout(i,300)}),e.addEventListener("blur",()=>{o&&clearTimeout(o),i()})),t&&t.addEventListener("change",()=>{const s=t.files&&t.files[0];if(!s)return;if(s.size>15e5){r("⛔ Image too large. Please choose a smaller photo (max ~1.5MB)."),t.value="";return}r("Uploading photo…");const a=new FileReader;a.onload=()=>{st(String(a.result||"")),r("✅ Photo saved"),k()},a.onerror=()=>r("⛔ Failed to read image."),a.readAsDataURL(s)}),n&&(n.onclick=()=>{at(),r("✅ Photo removed"),k()})}function ve(){return`
    <section style="
      padding:14px;
      border-radius:18px;
      border:1px solid rgba(255,255,255,.12);
  ...
  `}function we(){const e=T();return e==="profile"?te("Profile",`<div id="profileMount">${It()}</div>`):e==="bag"?te("Bag",`<div id="bagMount">${ve()}</div>`):""}function $t(){return`

(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const d of i.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&o(d)}).observe(document,{childList:!0,subtree:!0});function n(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(r){if(r.ep)return;r.ep=!0;const i=n(r);fetch(r.href,i)}})();const Y="cbsgo_state_v6";function se(e,t){try{const n=JSON.parse(e);return n&&typeof n=="object"?n:t}catch{return t}}function ae(){return{xp:0,completed:{},updatedAt:Date.now()}}function _(){const e=localStorage.getItem(Y);return se(e,ae())}function de(e){e.updatedAt=Date.now(),localStorage.setItem(Y,JSON.stringify(e))}function Z(e){return 100+(Math.max(1,Number(e||1))-1)*40}function M(){return Number(_().xp||0)}function P(){const e=M();let t=1,n=e;for(;;){const o=Z(t);if(n<o||(n-=o,t+=1,t>999))break}return t}function le(){const e=M();let t=1,n=e;for(;;){const o=Z(t);if(n<o||(n-=o,t+=1,t>999))break}return n}function ce(e){const t=Number(e);if(!Number.isFinite(t)||t<=0)return _();const n=_();return n.xp=Number(n.xp||0)+t,de(n),window.dispatchEvent(new CustomEvent("cbsgo:xpChanged",{detail:{xp:n.xp,level:P()}})),n}function B(e,t,n){const o=Number(e||0);return Number.isFinite(o)?Math.max(t,Math.min(n,o)):t}function pe(){const e=Number(M()||0),t=Number(P()||1),n=Number(le()||0),o=B(n,0,100),r=B(o/100*100,0,100);return`
  ...
  `}const U="cbsgo_inventory_v1";function ue(e,t){try{const n=JSON.parse(e);return n&&typeof n=="object"?n:t}catch{return t}}function fe(){return{tickets:0}}function L(){const e=localStorage.getItem(U);return ue(e,fe())}function ge(e){localStorage.setItem(U,JSON.stringify(e))}function V(){return Number(L().tickets||0)}function be(e=1){const t=Number(e||0);if(!Number.isFinite(t)||t<=0)return L();const n=L();return n.tickets=Number(n.tickets||0)+t,ge(n),window.dispatchEvent(new CustomEvent("cbsgo:inventoryChanged",{detail:{...n}})),n}const Q="cbsgo_steps_v7",me="cbsgo_gps_autostart_v3";let y=null,I=!1,p={msg:"init"};const D=120,R=1.5,F=150,j=.2,q=3.5;function v(){return{steps:0,meters:0,lastPos:null,rewarded5k:!1,rewarded10k:!1,updatedAt:Date.now()}}function h(){try{const e=localStorage.getItem(Q);if(!e)return v();const t=JSON.parse(e);return!t||typeof t!="object"?v():{...v(),...t}}catch{return v()}}function ee(e){e.updatedAt=Date.now();try{localStorage.setItem(Q,JSON.stringify(e))}catch{}}function x(){const e=h();return Number(e.steps||0)}function w(){return!!I}function ve(){return p}function ye(e,t){const o=c=>c*Math.PI/180,r=o(t.lat-e.lat),i=o(t.lng-e.lng),d=o(e.lat),s=o(t.lat),a=Math.sin(r/2)**2+Math.cos(d)*Math.cos(s)*Math.sin(i/2)**2;return 2*6371e3*Math.asin(Math.sqrt(a))}function xe(e){!e.rewarded5k&&e.steps>=5e3&&(e.rewarded5k=!0,ce(20)),!e.rewarded10k&&e.steps>=1e4&&(e.rewarded10k=!0,be(1))}function he(e){const t=Number(e||0);if(!Number.isFinite(t)||t<=0)return h();const n=h(),o=Number(n.meters||0);n.meters=o+t;const r=Math.floor(n.meters/.75);return r>n.steps&&(n.steps=r),xe(n),ee(n),window.dispatchEvent(new CustomEvent("cbsgo:stepsChanged",{detail:{steps:n.steps}})),n}function we(){y!=null&&navigator.geolocation&&navigator.geolocation.clearWatch(y),y=null}async function G(e={}){const t=!!e.silent;if(!navigator.geolocation)return p={err:"GPS not supported",t:Date.now()},t||console.warn("CBS GO: GPS not supported"),{ok:!1,reason:"GPS not supported"};try{localStorage.setItem(me,"1")}catch{}return we(),I=!0,p={msg:"requesting",t:Date.now()},y=navigator.geolocation.watchPosition(n=>{const o=n.coords.latitude,r=n.coords.longitude,i=n.coords.accuracy||999,d=Date.now(),s=h(),a=s.lastPos;if(p={lat:o,lng:r,acc:i,t:d},s.lastPos={lat:o,lng:r,t:d},ee(s),window.dispatchEvent(new CustomEvent("cbsgo:gps",{detail:{lat:o,lng:r,acc:i}})),i>D){p.reason=`acc > ${D}`,window.dispatchEvent(new CustomEvent("cbsgo:stepsChanged",{detail:{steps:x()}}));return}if(a&&typeof a.lat=="number"&&typeof a.lng=="number"){const c=ye({lat:a.lat,lng:a.lng},{lat:o,lng:r}),b=(d-a.t)/1e3||1,N=c/b;if(p.dist=c,p.speed=N,c<R)p.reason=`dist < ${R}`;else if(c>F)p.reason=`dist > ${F}`;else if(N<j)p.reason=`speed < ${j}`;else if(N>q)p.reason=`speed > ${q}`;else{p.reason="ok",p.added=c,he(c);return}}window.dispatchEvent(new CustomEvent("cbsgo:stepsChanged",{detail:{steps:x()}}))},n=>{I=!1,p={err:n?.message||"GPS blocked",t:Date.now()},t||console.warn("CBS GO: GPS error",n),window.dispatchEvent(new CustomEvent("cbsgo:stepsChanged",{detail:{steps:x()}}))},{enableHighAccuracy:!0,maximumAge:1e3,timeout:12e3}),{ok:!0}}function Se(){if(window.__cbsgo_try_autostart)return;window.__cbsgo_try_autostart=!0,(async()=>w()||await G({silent:!0}))();const t=async()=>{w()||await G({silent:!0}),window.removeEventListener("pointerdown",t),window.removeEventListener("touchstart",t),window.removeEventListener("click",t),window.removeEventListener("touchend",t)};window.addEventListener("pointerdown",t,{once:!0}),window.addEventListener("touchstart",t,{once:!0}),window.addEventListener("click",t,{once:!0})}function ke(){const e=ve();return e?.err?"🔴":e?.lat&&w()?"🟢":w()?"🟡":"⚪"}function te(){const e=x(),t=V();return`
    <div style="
      margin-top:6px;
      padding:8px 10px;
      border-radius:14px;
  ...
  `}const A="cbsgo_leaderboard_v2",ne="cbsgo_player_name_v2",C="cbsgo_player_avatar_v2";function oe(e,t){try{const n=localStorage.getItem(e);return n?JSON.parse(n):t}catch{return t}}function $e(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}}function z(){try{return localStorage.getItem(ne)||"Sovereign"}catch{return"Sovereign"}}function Ee(e){const t=String(e||"").trim().slice(0,24)||"Sovereign";try{localStorage.setItem(ne,t)}catch{}return t}function T(){try{return localStorage.getItem(C)||""}catch{return""}}function Me(e){const t=String(e||"");try{localStorage.setItem(C,t)}catch{}return t}function Ne(){try{localStorage.removeItem(C)}catch{}}function _e(e=10){const t=oe(A,[]);return Array.isArray(t)?t.slice(0,e):[]}function Le(){const e=z(),t=T(),n=M(),o=P(),r=oe(A,[]),i=Array.isArray(r)?r:[],d=i.find(s=>s.name===e);return d?(d.xp=n,d.level=o,d.avatar=t,d.t=Date.now()):i.push({name:e,xp:n,level:o,avatar:t,t:Date.now()}),i.sort((s,a)=>Number(a.xp||0)-Number(s.xp||0)),$e(A,i),{name:e,xp:n,level:o,avatar:t}}let l=null,m=null,u=null,S=!0;function k(e){return document.getElementById(e)}function f(e){const t=k("cbsgoMapHost");if(!t)return;let n=k("cbsgoMapMsg");n||(n=document.createElement("div"),n.id="cbsgoMapMsg",n.style.position="absolute",n.style.left="12px",n.style.right="12px",n.style.bottom="86px",n.style.zIndex="9999",n.style.padding="10px 12px",n.style.borderRadius="14px",n.style.border="1px solid rgba(255,255,255,.14)",n.style.background="rgba(0,0,0,.40)",n.style.color="#fff",n.style.fontFamily="system-ui, sans-serif",n.style.fontSize="13px",n.style.backdropFilter="blur(10px)",t.appendChild(n)),n.textContent=e||""}function Ie(){const e=String(z()||"").trim();return e?e[0].toUpperCase():"🙂"}function Ae(e){const t=T();if(t){const r=`
    ...
    ">${Ie()}</div>
  `;return e.divIcon({html:o,className:"",iconSize:[38,38],iconAnchor:[19,19]})}function Pe(){return`
  ...
  `}function Ce(){try{l&&(l.remove(),l=null,m=null)}catch{}}function ze(){const e=window.L,t=k("cbsgoMap");return!e||!t?!1:(Ce(),l=e.map(t,{zoomControl:!1,attributionControl:!1,worldCopyJump:!0}),e.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19}).addTo(l),l.setView([51.687,4.87],15),l.on("dragstart",()=>{S=!1}),l.on("zoomstart",()=>{S=!1}),!0)}function X(e,t){if(!l||!window.L)return;const n=window.L,o=Ae(n);if(m?(m.setIcon(o),m.setLatLng([e,t])):m=n.marker([e,t],{icon:o}).addTo(l),S){const r=l.getZoom()||15,i=Math.max(r,16);l.setView([e,t],i,{animate:!0})}}function Te(){const e=document.getElementById("cbsgoCompassArrow");if(!e||typeof window.DeviceOrientationEvent>"u")return;const t=n=>{let o=null;typeof n.webkitCompassHeading=="number"?o=n.webkitCompassHeading:typeof n.alpha=="number"&&(o=360-n.alpha),!(o==null||!Number.isFinite(o))&&(e.style.transform=`rotate(${o}deg)`)};window.addEventListener("deviceorientation",t,!0)}function Oe(){let e=0;const t=80,n=()=>{if(e++,!k("cbsgoMap"))return e<t?setTimeout(n,100):void 0;if(!window.L){if(f("Loading map engine…"),e<t)return setTimeout(n,100);f("Map engine failed to load (Leaflet not found). Refresh.");return}if(!ze()){f("Could not init map. Refresh.");return}f("Waiting for GPS…"),Te();const r=document.getElementById("cbsgoRecenterBtn");r&&(r.onclick=()=>{if(S=!0,u&&l){const{lat:d,lng:s}=u,a=l.getZoom()||15,c=Math.max(a,16);l.setView([d,s],c,{animate:!0})}});const i=d=>{const s=d?.detail||{},a=Number(s.lat),c=Number(s.lng),b=Number(s.acc);!Number.isFinite(a)||!Number.isFinite(c)||(u={lat:a,lng:c,acc:b},X(a,c),Number.isFinite(b)?f(`GPS • ±${Math.round(b)}m`):f("GPS active"))};window.addEventListener("cbsgo:gps",i),u&&X(u.lat,u.lng)};n()}function re(){try{return new URLSearchParams(window.location.search).get("dev")==="1"}catch{return!1}}function Be(){try{const e=[];for(let t=0;t<localStorage.length;t++){const n=localStorage.key(t);n&&n.startsWith("cbsgo_")&&e.push(n)}e.forEach(t=>localStorage.removeItem(t))}catch{}try{const e=[];for(let t=0;t<sessionStorage.length;t++){const n=sessionStorage.key(t);n&&n.startsWith("cbsgo_")&&e.push(n)}e.forEach(t=>sessionStorage.removeItem(t))}catch{}window.location.reload()}function $(e){return String(e||"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function H(e,t=30){const n=e?`background-image:url('${e}');`:"";return`
    <div style="
      ...
      font-size:16px;
    ">${e?"":"👤"}</div>
  `}function O(){try{return sessionStorage.getItem("cbsgo_selected_tab_v6")||"map"}catch{return"map"}}function J(e){try{sessionStorage.setItem("cbsgo_selected_tab_v6",e)}catch{}}function De(){const e=O(),t=(n,o,r)=>`
  ...
  `}function Re(){const e=_e(10),t=z(),n=T();return`
  ...
  `}function Fe(){const e=document.querySelector("#lbName"),t=document.querySelector("#lbSubmit"),n=document.querySelector("#lbAvatar"),o=document.querySelector("#lbRemoveAvatar");let r=null;const i=s=>{const a=document.querySelector("#lbMsg");a&&(a.textContent=s||"")};e&&i(`✅ Profile loaded: ${e.value}`);const d=()=>{if(!e)return;const s=Ee(e.value);i(`✅ Name saved: ${s}`)};e&&(e.addEventListener("input",()=>{i("Saving…"),r&&clearTimeout(r),r=setTimeout(d,300)}),e.addEventListener("blur",()=>{r&&clearTimeout(r),d()})),n&&n.addEventListener("change",()=>{const s=n.files&&n.files[0];if(!s)return;if(s.size>15e5){i("⛔ Image too large. Please choose a smaller photo (max ~1.5MB)."),n.value="";return}i("Uploading photo…");const a=new FileReader;a.onload=()=>{Me(String(a.result||"")),i("✅ Photo saved"),g()},a.onerror=()=>i("⛔ Failed to read image."),a.readAsDataURL(s)}),o&&(o.onclick=()=>{Ne(),i("✅ Photo removed"),g()}),t&&(t.onclick=()=>{e&&d();const s=Le();i(`✅ Saved: ${s.name} – ${s.xp} XP`),g()})}function je(){return`
    <div style="
      padding:12px;
      border-radius:16px;
      border:1px solid rgba(255,255,255,.12);
  ...
  `}function qe(){const e=O();return e==="profile"?K("Profile",`<div id="lbMount">${Re()}</div>`):e==="bag"?K("Bag",`<div id="bagMount">${je()}</div>`):""}function Ge(){const e=re();return`
  ...
  `}function Xe(){document.querySelectorAll("[data-tab]").forEach(t=>{t.addEventListener("click",()=>{const n=t.getAttribute("data-tab");J(n||"map"),g()})});const e=document.querySelector("#cbsgoClosePanel");e&&e.addEventListener("click",()=>{J("map"),g()})}function g(){const e=document.querySelector("#app");if(!e)return;if(e.innerHTML=Ge(),Xe(),Oe(),Se(),!window.__cbsgo_steps_rerender_listener){window.__cbsgo_steps_rerender_listener=!0;const n=()=>{const o=document.querySelector("#stepsMount");o&&(o.innerHTML=te())};window.addEventListener("cbsgo:stepsChanged",n)}if(O()==="profile"&&Fe(),re()){const n=document.querySelector("#resetBtn");n&&n.addEventListener("click",Be)}}function ie(){let e=document.getElementById("cbsgoHud");return e||(e=document.createElement("div"),e.id="cbsgoHud",e.style.position="fixed",e.style.left="10px",e.style.right="10px",e.style.bottom="10px",e.style.zIndex="999999",e.style.padding="10px 12px",e.style.borderRadius="14px",e.style.border="1px solid rgba(255,255,255,.18)",e.style.background="rgba(0,0,0,.55)",e.style.backdropFilter="blur(10px)",e.style.color="#fff",e.style.fontFamily="system-ui, sans-serif",e.style.fontSize="12px",e.style.whiteSpace="pre-wrap",e.style.display="none",document.body.appendChild(e),e)}function E(e){const t=ie();t.textContent=String(e||""),t.style.display="block"}window.addEventListener("error",e=>{const t=e?.filename?`${e.filename}:${e.lineno||0}:${e.colno||0}`:"";E(`❌ Error
${e?.message||e}

  ...
  `}function ye(){const e=q();return e==="profile"?X("Profile",`<div id="profileMount">${vt()}</div>`):e==="bag"?X("Bag",`<div id="bagMount">${_t()}</div>`):""}function kt(){return`
    ...
    ">
      ...
      <div id="fabNav" style="
        position:absolute;
        right:16px;
        bottom:48px; /* ⬅ verlaagd: onder 🧭/🎯, boven GPS-balk */
        z-index:5000;
        display:flex;
        flex-direction:row;
        gap:10px;

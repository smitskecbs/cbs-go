...
Needed: ≤ ${Te}m`);return}R.removeLayer(r),V=null,se({id:`puzzle-${Date.now()}`,name:"CBS GO Puzzle"})}),r.addTo(R),V=r}function fn(){return`
  ...
  `}function gn(){try{x&&(x.remove(),x=null,O=null,R=null,P=null,k=null,Y=!1,ae=0,Z=0,V=null)}catch{}}function bn(){const e=window.L,t=I("cbsgoMap");if(!e||!t)return!1;gn();const n=e.latLngBounds(e.latLng(-85,-180),e.latLng(85,180));return x=e.map(t,{zoomControl:!1,attributionControl:!1,worldCopyJump:!0,maxBounds:n,maxBoundsViscosity:1,minZoom:1,maxZoom:19}),e.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19,noWrap:!0,bounds:n}).addTo(x),x.setView([51.687,4.87],16),R=e.layerGroup().addTo(x),P=e.layerGroup().addTo(x),!0}function mn(e){const t=window.L;if(!t||!x)return;const n=rn(t);if(!O){O=t.marker(e,{icon:n}).addTo(x),x.setView(e,18);return}O.setIcon(n),O.setLatLng(e)}function yn(){!navigator.geolocation||!x||!window.L||navigator.geolocation.watchPosition(e=>{const{latitude:t,longitude:n,accuracy:o}=e.coords,r={lat:t,lng:n},s=k?{lat:k[0],lng:k[1]}:null;if(k=[t,n],mn([t,n]),s){const d=pe(s,r);Number.isFinite(d)&&d>1&&(Z+=d)}pn(r),un(r),A(`GPS OK • accuracy ~${Math.round(o)}m`)},e=>{A(`GPS error: ${e?.message||e?.code||"unknown"}`)},{enableHighAccuracy:!0,maximumAge:0,timeout:2e4})}function hn(){let e=0;const t=120,n=()=>{if(e++,!I("cbsgoMap"))return e<t?setTimeout(n,100):void 0;if(!window.L){if(A("Loading map engine…"),e<t)return setTimeout(n,100);A("Map engine failed to load (Leaflet not found). Refresh.");return}if(!bn()){A("Could not init map. Refresh.");return}const r=I("cbsgoCenterBtn");r&&(r.onclick=()=>{x&&k&&x.setView(k,18)});const s=I("cbsgoCompassBtn");s&&(s.onclick=()=>{x&&(Y=!Y,Y?x.setView([51.687,4.87],3):k&&x.setView(k,16))}),A("Loading GPS…"),yn()};n()}function nt(e){return String(e||"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function xn(e,t=30){const n=e?`background-image:url('${e}');`:"";return`
    <div style="

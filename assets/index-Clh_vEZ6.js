...
Currently: ${l}/${a}`);return}if(!T(s.id)){alert("Join this Group Node first to receive a role (A–E).");return}}W(s)}}))}function Se(){const e=N(),t=de(e),n=pe(e),o=Math.min(100,Math.max(0,Number(n)||0));return`
  ...
  `}function re(){try{return new URLSearchParams(window.location.search).get("dev")==="1"}catch{return!1}}function $e(){try{const e=[];for(let t=0;t<localStorage.length;t++){const n=localStorage.key(t);n&&n.startsWith("cbsgo_")&&e.push(n)}e.forEach(t=>localStorage.removeItem(t))}catch{}try{const e=[];for(let t=0;t<sessionStorage.length;t++){const n=sessionStorage.key(t);n&&n.startsWith("cbsgo_")&&e.push(n)}e.forEach(t=>sessionStorage.removeItem(t))}catch{}window.location.reload()}const M="cbsgo_leaderboard_v2",k="cbsgo_player_name_v1",z="cbsgo_player_avatar_v1",_e="cbsgo_state_v1";function R(e,t){try{const n=localStorage.getItem(e);return n?JSON.parse(n)??t:t}catch{return t}}function Ne(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}}function Ae(){const e=["Sovereign","Builder","Runner","Scout","Mapper","Guardian","Wanderer","Cipher"],t=Math.random().toString(16).slice(2,6).toUpperCase();return`${e[Math.floor(Math.random()*e.length)]}-${t}`}function I(){let e="";try{e=localStorage.getItem(k)||""}catch{}if(!e){e=Ae();try{localStorage.setItem(k,e)}catch{}}return e}function Me(e){const t=String(e||"").trim().slice(0,24);if(!t)return I();try{localStorage.setItem(k,t)}catch{}return t}function O(){try{return localStorage.getItem(z)||""}catch{return""}}function ke(e){const t=String(e||"");try{localStorage.setItem(z,t)}catch{}return t}function Ee(){try{localStorage.removeItem(z)}catch{}}function Le(){const e=R(_e,{}),t=Number(e?.xp??0),n=Number(e?.level??1);return{xp:Number.isFinite(t)?t:0,level:Number.isFinite(n)?n:1}}function ie(e){return(Array.isArray(e)?e:[]).map(n=>({name:String(n?.name??"").slice(0,24),xp:Number(n?.xp??0)||0,level:Number(n?.level??1)||1,avatar:String(n?.avatar??""),ts:Number(n?.ts??0)||0})).filter(n=>n.name.length>0)}function Ce(e=10){const t=ie(R(M,[]));return t.sort((n,o)=>o.xp-n.xp||o.level-n.level||o.ts-n.ts),t.slice(0,e)}function Pe(){const{xp:e,level:t}=Le(),n=I(),o=O(),i={name:n,xp:e,level:t,avatar:o,ts:Date.now()},r=ie(R(M,[])),s=r.findIndex(a=>a.name===n);return s>=0?i.xp>=Number(r[s]?.xp??0)?r[s]=i:o&&o!==r[s].avatar&&(r[s]={...r[s],avatar:o,ts:Date.now()}):r.push(i),r.sort((a,l)=>l.xp-a.xp||l.level-a.level||l.ts-a.ts),Ne(M,r.slice(0,50)),i}function _(e){return String(e||"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function qe(e){const t=[{left:"14%",top:"68%"},{left:"44%",top:"44%"},{left:"76%",top:"70%"},{left:"52%",top:"82%"}];return t[e%t.length]}function se(){return`
    ...
    ">
      ...
      <div id="cbsgoFakeMap" style="
        ...
        overflow:hidden;
      ">
        ${S.map((e,t)=>{const n=P(e.id),o=qe(t);return`
            <button
              type="button"
              class="cbsgo-pin"
              data-node-id="${_(e.id)}"
  ...
  `}function K(){window.__cbsgo_map_click_bound||(window.__cbsgo_map_click_bound=!0,document.addEventListener("click",e=>{const t=e.target.closest(".cbsgo-pin");if(!t)return;const n=t.getAttribute("data-node-id");n&&(console.log("[MAP CLICK]",{id:n}),window.dispatchEvent(new CustomEvent("cbsgo:openNode",{detail:{id:n}})))}))}function V(e){return String(e||"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function E(e,t=30){const n=e?`background-image:url('${e}');`:"";return`
    <div style="
      ...
      font-size:16px;
    ">${e?"":"👤"}</div>
  `}function x(){const e=Ce(10),t=I(),n=O();return`

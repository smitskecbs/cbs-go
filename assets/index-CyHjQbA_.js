(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function n(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(o){if(o.ep)return;o.ep=!0;const s=n(o);fetch(o.href,s)}})();const V="cbsgo_state_v3";function pt(t,e){try{const n=JSON.parse(t);return n&&typeof n=="object"?n:e}catch{return e}}function ut(){return{xp:0,completed:{}}}function h(){const t=localStorage.getItem(V);return pt(t,ut())}function W(t){localStorage.setItem(V,JSON.stringify(t))}function L(){return Number(h().xp||0)}function R(t){const e=Math.max(0,Number(t||0));return Math.floor(e/100)+1}function gt(t){return Math.max(0,Number(t||0))%100}function U(t){const e=Number(t||0);if(!Number.isFinite(e)||e<=0)return L();const n=h();return n.xp=Number(n.xp||0)+e,W(n),window.dispatchEvent(new CustomEvent("cbsgo:xpChanged",{detail:{xp:n.xp,delta:e}})),n.xp}function z(t){const e=String(t||"");return e?!!h().completed?.[e]:!1}function ft(t){const e=String(t||"");if(!e)return!1;const n=h();return n.completed?.[e]?!1:(n.completed[e]=Date.now(),W(n),window.dispatchEvent(new CustomEvent("cbsgo:nodeCompleted",{detail:{id:e}})),!0)}function Z(){const t=L(),e=R(t),n=gt(t),r=Math.min(100,Math.max(0,n));return`
  ...
  `}function Q(){try{return new URLSearchParams(window.location.search).get("dev")==="1"}catch{return!1}}function mt(){try{const t=[];for(let e=0;e<localStorage.length;e++){const n=localStorage.key(e);n&&n.startsWith("cbsgo_")&&t.push(n)}t.forEach(e=>localStorage.removeItem(e))}catch{}try{const t=[];for(let e=0;e<sessionStorage.length;e++){const n=sessionStorage.key(e);n&&n.startsWith("cbsgo_")&&t.push(n)}t.forEach(e=>sessionStorage.removeItem(e))}catch{}window.location.reload()}const I="cbsgo_leaderboard_v2",tt="cbsgo_player_name_v2",G="cbsgo_player_avatar_v2";function et(t,e){try{const n=localStorage.getItem(t);return n?JSON.parse(n):e}catch{return e}}function yt(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}function F(){try{return localStorage.getItem(tt)||"Sovereign"}catch{return"Sovereign"}}function bt(t){const e=String(t||"").trim().slice(0,24)||"Sovereign";try{localStorage.setItem(tt,e)}catch{}return e}function w(){try{return localStorage.getItem(G)||""}catch{return""}}function vt(t){const e=String(t||"");try{localStorage.setItem(G,e)}catch{}return e}function xt(){try{localStorage.removeItem(G)}catch{}}function ht(t=10){const e=et(I,[]);return Array.isArray(e)?e.slice(0,t):[]}function wt(){const t=F(),e=w(),n=L(),r=R(n),o=et(I,[]),s=Array.isArray(o)?o:[],a=s.find(i=>i.name===t);return a?(a.xp=n,a.level=r,a.avatar=e,a.t=Date.now()):s.push({name:t,xp:n,level:r,avatar:e,t:Date.now()}),s.sort((i,c)=>Number(c.xp||0)-Number(i.xp||0)),yt(I,s),{name:t,xp:n,level:r,avatar:e}}const St=[{id:"stop-a1",name:"Clock Code",type:"puzzle",description:"A tiny plate shows 3 letters.",xp:40,question:"Type: cbs",hint:"lowercase",answers:["cbs"]},{id:"stop-a2",name:"Bridge Marker",type:"puzzle",description:"The river reflects the truth.",xp:45,question:"Type: sovereign",hint:"lowercase",answers:["sovereign"]},{id:"stop-a3",name:"Stone Sign",type:"puzzle",description:"An old stone has one word.",xp:35,question:"Type: freedom",hint:"lowercase",answers:["freedom"]},{id:"stop-a4",name:"Hidden Initials",type:"puzzle",description:"Look for the initials.",xp:35,question:"Type: unity",hint:"lowercase",answers:["unity"]},{id:"stop-a5",name:"Red Door",type:"puzzle",description:"A door has a sticker with a number.",xp:30,question:"Type: 12",hint:"just the number",answers:["12"]},{id:"stop-a6",name:"Green Bench",type:"puzzle",description:"Bench plaque has one word.",xp:30,question:"Type: community",hint:"lowercase",answers:["community"]},{id:"stop-a7",name:"Old Map Pin",type:"puzzle",description:"A torn paper shows a short code.",xp:40,question:"Type: go",hint:"lowercase",answers:["go"]},{id:"stop-a8",name:"Blue Fence",type:"puzzle",description:"Count the bars.",xp:35,question:"Type: 7",hint:"just the number",answers:["7"]},{id:"stop-a9",name:"Street Lantern",type:"puzzle",description:"Lantern sticker shows a letter.",xp:30,question:"Type: s",hint:"lowercase letter",answers:["s"]},{id:"stop-a10",name:"Sovereign Seal",type:"puzzle",description:"A seal with 3 letters.",xp:50,question:"Type: dao",hint:"lowercase",answers:["dao"]}];function N(t){return String(t||"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function nt(t){return String(t||"").toLowerCase().trim().replace(/\s+/g," ")}function kt(){let t=document.querySelector("#cbsgoModal");return t||(t=document.createElement("div"),t.id="cbsgoModal",t.style.position="fixed",t.style.inset="0",t.style.zIndex="9999",t.style.display="none",t.style.alignItems="center",t.style.justifyContent="center",t.style.padding="18px",t.style.background="rgba(0,0,0,.55)",t.addEventListener("click",e=>{e.target===t&&E()}),document.body.appendChild(t),t)}function E(){const t=document.querySelector("#cbsgoModal");t&&(t.style.display="none",t.innerHTML="")}function $t(t){return(Array.isArray(t?.answers)?t.answers:t?.answer?[t.answer]:[]).map(nt).filter(Boolean)}function Mt(t){return t?.question||t?.puzzle?.question||`Solve the node: ${t?.name||""}`}function _t(t){return t?.hint||t?.puzzle?.hint||""}function Lt(t){const e=Number(t?.xp??t?.rewardXp??50);return Number.isFinite(e)?e:50}function At(t){const e=kt(),n=String(t?.id||""),r=z(n),o=Mt(t),s=_t(t),a=Lt(t),i=$t(t);e.style.display="flex",e.innerHTML=`
    ...
    ">
      ...
      <div style="margin-top:12px; padding:12px; border-radius:14px; border:1px solid rgba(255,255,255,.10); background:rgba(255,255,255,.04);">
        ...
        ${s?`<div style="margin-top:10px; font-size:13px; opacity:.8;"><b>Hint:</b> ${N(s)}</div>`:""}
      </div>
  ...
  `;const c=e.querySelector("#cbsgoClose");if(c&&(c.onclick=E),r)return;const l=e.querySelector("#cbsgoMsg"),m=e.querySelector("#cbsgoAnswer"),g=e.querySelector("#cbsgoSubmit"),p=u=>{l&&(l.textContent=u||"")},f=()=>{if(!n)return;if(z(n)){p("✅ Already completed.");return}const u=nt(m?.value||"");if(i.length===0){p("⚠️ This node has no answers configured yet.");return}if(!i.includes(u)){p("❌ Not correct. Try again.");return}if(!ft(n)){p("✅ Already completed.");return}U(a),p(`✅ Correct! +${a} XP`),setTimeout(()=>E(),550)};g&&(g.onclick=f),m&&(m.addEventListener("keydown",u=>{u.key==="Enter"&&f()}),setTimeout(()=>m.focus(),50))}const ot="cbsgo_inventory_v1";function Nt(t,e){try{const n=JSON.parse(t);return n&&typeof n=="object"?n:e}catch{return e}}function zt(){return{tickets:0,fireworks:0,chests:0}}function P(){const t=localStorage.getItem(ot);return Nt(t,zt())}function It(t){localStorage.setItem(ot,JSON.stringify(t))}function Et(){return P()}function Pt(t){const e=Number(t);if(!Number.isFinite(e)||e===0)return P();const n=P();return n.tickets=Math.max(0,Number(n.tickets||0)+e),It(n),window.dispatchEvent(new CustomEvent("cbsgo:inventoryChanged",{detail:{inv:n}})),n}const rt="cbsgo_steps_v1";function Tt(t,e){try{const n=JSON.parse(t);return n&&typeof n=="object"?n:e}catch{return e}}function qt(){return{steps:0,meters:0,last5kAwardAt:0,last10kAwardAt:0}}function M(){const t=localStorage.getItem(rt);return Tt(t,qt())}function Ct(t){localStorage.setItem(rt,JSON.stringify(t))}const Ot=.78;function Bt(t){const e=Number(t||0);if(!Number.isFinite(e)||e<=0)return M();const n=M();n.meters=Number(n.meters||0)+e;const r=Number(n.steps||0),o=Math.floor(Number(n.meters||0)/Ot);n.steps=o;const s=Number(n.steps||0),a=s-r,i=Math.floor(s/5e3)*5e3;if(i>=5e3&&i>Number(n.last5kAwardAt||0)){for(let l=Number(n.last5kAwardAt||0)+5e3;l<=i;l+=5e3)U(20);n.last5kAwardAt=i}const c=Math.floor(s/1e4)*1e4;if(c>=1e4&&c>Number(n.last10kAwardAt||0)){for(let l=Number(n.last10kAwardAt||0)+1e4;l<=c;l+=1e4)Pt(1);n.last10kAwardAt=c}return Ct(n),window.dispatchEvent(new CustomEvent("cbsgo:stepsChanged",{detail:{steps:n.steps,meters:n.meters,addedSteps:a}})),n}const T="cbsgo_last_pos_v3",q="cbsgo_nodes_pos_v2",st="cbsgo_gps_autostart_v1",it="cbsgo_follow_me_v1";function A(t,e){try{const n=localStorage.getItem(t);return n?JSON.parse(n):e}catch{return e}}function at(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}function Rt(t){return String(t).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function J(t,e){const r=l=>l*Math.PI/180,o=r(e.lat-t.lat),s=r(e.lng-t.lng),a=r(t.lat),i=r(e.lat),c=Math.sin(o/2)**2+Math.cos(a)*Math.cos(i)*Math.sin(s/2)**2;return 2*6371e3*Math.asin(Math.sqrt(c))}let d=null,k=null,$=null,x=null,b=null;function j(){const t=window.L;return t&&typeof t.map=="function"?t:null}function ct(){$!=null&&navigator.geolocation&&navigator.geolocation.clearWatch($),$=null}function D(){try{const t=localStorage.getItem(it);return t==null?!0:t==="1"}catch{return!0}}function C(t){try{localStorage.setItem(it,t?"1":"0")}catch{}}function lt(){return St.filter(t=>t.type!=="group"&&!z(t.id))}function Gt(t){const e=A(q,null);if(e&&e.seed&&e.posById)return e;const n=lt(),r={},o=[],s=90,a=160,i=420,c=4e3;function l(p,f,u){const S=f*Math.cos(u)/111111,y=f*Math.sin(u)/(111111*Math.cos(p*Math.PI/180));return{dLat:S,dLng:y}}let m=0;for(const p of n){let f=!1;for(;!f&&m<c;){m++;const u=a+Math.random()*(i-a),S=Math.random()*Math.PI*2,y=l(t.lat,u,S),Y={lat:t.lat+y.dLat,lng:t.lng+y.dLng};f=o.every(dt=>J(dt,Y)>=s),f&&(o.push(Y),r[p.id]={dLat:y.dLat,dLng:y.dLng})}if(!r[p.id]){const u=l(t.lat,a,Math.random()*Math.PI*2);r[p.id]={dLat:u.dLat,dLng:u.dLng}}}const g={seed:t,posById:r,createdAt:Date.now()};return at(q,g),g}function Ft(t,e){const n=A(q,null),r=n?.seed||e,o=n?.posById?.[t.id];return!r||!o?null:{lat:r.lat+o.dLat,lng:r.lng+o.dLng}}function K(t){const e=document.querySelector("#nearInfo");e&&(e.textContent=t||"")}function Jt(t){const e=w();if(!e)return null;const n=`
    <div style="
  ...
  `}function Dt(t){const e=j();if(!e||!d)return;k||(k=e.layerGroup().addTo(d)),k.clearLayers();const n=lt(),r=Gt(t),o=[];for(const a of n){const i=Ft(a,r.seed);if(!i)continue;const c=Math.round(J(t,i));c>1200||o.push({node:a,ll:i,dist:c})}o.sort((a,i)=>a.dist-i.dist),o.length===0?K("No nodes nearby (walk a bit)."):K(`Nearest: ${o[0].node.name} • ${o[0].dist}m • Visible: ${o.length} (must be close to open)`);const s=60;o.forEach(({node:a,ll:i,dist:c})=>{const l=e.circleMarker([i.lat,i.lng],{radius:11,weight:2});l.bindTooltip(`${a.name} • ${c}m`,{direction:"top",offset:[0,-10]}),l.on("click",()=>{if(c>s){alert(`Too far.

Go closer to open:
${a.name}
Distance: ${c}m
Required: ≤ ${s}m`);return}At(a)}),l.addTo(k)})}function Xt(t){const e=j();return e?(d?setTimeout(()=>d.invalidateSize(),80):(d=e.map(t,{zoomControl:!0}),e.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19,attribution:"&copy; OpenStreetMap"}).addTo(d),d.setView([51.687,4.867],16),d.on("dragstart",()=>{C(!1);const n=document.querySelector("#followBtn");n&&(n.textContent="Free look 👀")}),d.on("zoomstart",()=>{C(!1);const n=document.querySelector("#followBtn");n&&(n.textContent="Free look 👀")})),!0):!1}function O(){const t=document.querySelector("#stepsLine");if(!t)return;const e=M();t.innerHTML=`Steps: <b>${Number(e.steps||0)}</b>`}function H(t){if(!navigator.geolocation){t("❌ GPS not supported.");return}try{localStorage.setItem(st,"1")}catch{}t("Requesting GPS…");const e=80;ct(),$=navigator.geolocation.watchPosition(n=>{const r=n.coords.latitude,o=n.coords.longitude,s=n.coords.accuracy||999;if(s>e){t(`GPS OK but accuracy low (${Math.round(s)}m). Move outside.`);return}t(`✅ GPS active (±${Math.round(s)}m)`);const a={lat:r,lng:o},i=j();if(i&&d){const l=Jt(i);l&&(!b||JSON.stringify(b?.options)!==JSON.stringify(l?.options))&&(b=l,x&&x.setIcon(b)),x?x.setLatLng([r,o]):x=b?i.marker([r,o],{icon:b}).addTo(d):i.circleMarker([r,o],{radius:8,weight:2}).addTo(d)}d&&D()&&d.setView([r,o],Math.max(d.getZoom(),17),{animate:!0});const c=A(T,null);if(c){const l=J(c,a);l>=6&&l<=90&&(Bt(l),O())}at(T,a),Dt(a)},n=>{t(`❌ GPS blocked: ${n?.message||"error"}`)},{enableHighAccuracy:!0,maximumAge:1e3,timeout:12e3})}function Yt(){const t=document.querySelector("#mapMount")||document,e=t.querySelector("#leafletMap"),n=t.querySelector("#gpsStartBtn"),r=t.querySelector("#gpsStopBtn"),o=t.querySelector("#gpsStatus"),s=t.querySelector("#followBtn");if(!e)return;const a=l=>{o&&(o.textContent=l||"")};let i=0;const c=()=>{if(i++,!Xt(e)){a("Loading map engine…"),i<30?setTimeout(c,150):a("❌ Leaflet not loaded. Check index.html CDN.");return}a("Map ready. Enable GPS."),s&&(s.onclick=()=>{const g=!D();if(C(g),s.textContent=g?"Following ✅":"Free look 👀",g&&d){const p=A(T,null);p&&d.setView([p.lat,p.lng],Math.max(d.getZoom(),17),{animate:!0})}}),n&&(n.onclick=()=>H(a)),r&&(r.onclick=()=>{ct(),a("GPS stopped.")}),O(),(()=>{try{return localStorage.getItem(st)==="1"}catch{return!1}})()&&H(a),window.__cbsgo_steps_listener_v1||(window.__cbsgo_steps_listener_v1=!0,window.addEventListener("cbsgo:stepsChanged",O))};c()}function Kt(){return jt()}function Ht(){return Yt()}function B(t){return String(t||"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function X(t,e=30){const n=t?`background-image:url('${t}');`:"";return`
    <div style="
  ...
  `}function Qt(){const t=F(),e=w(),n=L(),r=R(n),o=h(),s=o?.completed?Object.keys(o.completed).length:0;return`
    <section style="
      margin-top:14px;
      padding:14px;
      border-radius:18px;
    ...
    ">
      <div style="display:flex; gap:12px; align-items:center; flex-wrap:wrap;">
        ...
        <div style="flex:1; min-width:220px;">
          ...
          <div style="opacity:.75; margin-top:2px;">Nodes completed: <b>${s}</b></div>
        </div>
      </div>
  ...
  `}function te(){const t=document.querySelector("#pfName"),e=document.querySelector("#pfSaveScore"),n=document.querySelector("#pfAvatar"),r=document.querySelector("#pfRemoveAvatar"),o=document.querySelector("#pfMsg"),s=i=>{o&&(o.textContent=i||"")},a=()=>{if(!t)return;const i=bt(t.value);s(`✅ Name saved: ${i}`)};t&&(t.addEventListener("blur",a),t.addEventListener("keydown",i=>{i.key==="Enter"&&a()})),n&&n.addEventListener("change",()=>{const i=n.files&&n.files[0];if(!i)return;if(i.size>15e5){s("❌ Image too large (max ~1.5MB)."),n.value="";return}s("Uploading photo…");const c=new FileReader;c.onload=()=>{vt(String(c.result||"")),s("✅ Photo saved"),v()},c.onerror=()=>s("❌ Failed to read image."),c.readAsDataURL(i)}),r&&(r.onclick=()=>{xt(),s("✅ Photo removed"),v()}),e&&(e.onclick=()=>{a();const i=wt();s(`✅ Saved: ${i.name} – ${i.xp} XP (Level ${i.level})`),v()})}function ee(){const t=Et(),e=(n,r,o)=>`
    <div style="
      display:flex; align-items:center; justify-content:space-between; gap:10px;
      padding:12px;
      border-radius:14px;

...
(Each letter is shifted +1 from the original.)`,hint:"Try shifting letters back by 1.",code:"CAS",explain:"DBT shifted back by 1 → CAS."}},{id:"node-4",type:"puzzle",name:"Steps Math",description:"Quick math check.",xp:50,puzzle:{type:"input",q:"If you walk 2 km and your step length is 0.8 m, about how many steps is that? (Round to whole number)",answers:["2500"],explain:"2000m / 0.8m ≈ 2500 steps."}},{id:"node-5",type:"puzzle",name:"CBS Motto",description:"Community memory.",xp:30,puzzle:{type:"code",q:"Type the CBS motto (3 words):",hint:"C _ _ _ _ _ _ _  B _ _ _ _ _  S _ _ _ _ _ _ _ _ _",code:"COMMUNITY BUILDS SOVEREIGNTY",explain:"CBS = Community Builds Sovereignty."}}],Mr="cbsgo_state_v6";function So(t,n){try{const o=JSON.parse(t);return o&&typeof o=="object"?o:n}catch{return n}}function ko(){return{xp:0,completed:{},updatedAt:Date.now()}}function Gt(){const t=localStorage.getItem(Mr);return So(t,ko())}function Lr(t){t.updatedAt=Date.now(),localStorage.setItem(Mr,JSON.stringify(t))}function Hn(t){return 100+(Math.max(1,Number(t||1))-1)*40}function un(){return Number(Gt().xp||0)}function Wt(){const t=un();let n=1,o=t;for(;;){const l=Hn(n);if(o<l||(o-=l,n+=1,n>999))break}return n}function Ar(){const t=un();let n=1,o=t;for(;;){const l=Hn(n);if(o<l||(o-=l,n+=1,n>999))break}return o}function Br(){return Hn(Wt())}function qt(t){const n=Number(t||0);if(!Number.isFinite(n)||n<=0)return Gt();const o=Wt(),l=Gt();l.xp=Number(l.xp||0)+n,Lr(l);const c=Wt();return window.dispatchEvent(new CustomEvent("cbsgo:xpChanged",{detail:{xp:l.xp,level:c}})),c>o&&(window.dispatchEvent(new CustomEvent("cbsgo:levelUp",{detail:{from:o,to:c,xp:l.xp}})),window.dispatchEvent(new CustomEvent("cbsgo:levelChanged",{detail:{level:c,xp:l.xp}}))),l}function zr(t){const n=String(t||"");if(!n)return!1;const o=Gt();return!!(o.completed&&o.completed[n])}function Nr(t){const n=String(t||"");if(!n)return;const o=Gt();o.completed||(o.completed={}),o.completed[n]=Date.now(),Lr(o),window.dispatchEvent(new CustomEvent("cbsgo:nodeCompleted",{detail:{id:n}}))}const Co=Object.freeze(Object.defineProperty({__proto__:null,addXp:qt,completeNode:Nr,getLevel:Wt,getXp:un,getXpIntoLevel:Ar,getXpNeededThisLevel:Br,isNodeCompleted:zr},Symbol.toStringTag,{value:"Module"})),Ir="cbsgoPuzzleModal";function Eo(t){return String(t).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Nn(){const t=document.getElementById(Ir);t&&t.remove()}function Rn(t){Nn();const n=6,o=6,l=["#f97373","#facc15","#4ade80","#60a5fa","#a855f7"],c=["🍬","💎","⭐","🍀","🔮"],f=180,u=18,p=l.length,b=.01;let x=[],h=null,y=0,_=u,T=!1,P=!1,E=null;const N=t?.name||"CBS GO Puzzle",q=document.createElement("div");q.id=Ir,q.style.position="fixed",q.style.inset="0",q.style.zIndex="999999",q.style.display="flex",q.style.alignItems="center",q.style.justifyContent="center",q.style.padding="16px",q.style.background="rgba(0,0,0,.70)",q.style.backdropFilter="blur(12px)",q.style.fontFamily="system-ui, sans-serif",q.style.color="#fff",q.innerHTML=`
  ...
  `}function Fr(){const{stepsToday:t,goalSteps:n,goalReached:o,streak:l,streakLength:c,rewardPerStreak:f}=Qo(),u=n>0?Math.min(100,Math.round(t/n*100)):0,p=(l||[]).map(x=>x.reached?"★":"☆").join(" ");return`
  ...
  `}function Ur(){try{return new URLSearchParams(window.location.search).get("dev")==="1"}catch{return!1}}function ci(){try{const t=[];for(let n=0;n<localStorage.length;n++){const o=localStorage.key(n);o&&o.startsWith("cbsgo_")&&t.push(o)}t.forEach(n=>localStorage.removeItem(n))}catch{}try{const t=[];for(let n=0;n<sessionStorage.length;n++){const o=sessionStorage.key(n);o&&o.startsWith("cbsgo_")&&t.push(o)}t.forEach(n=>sessionStorage.removeItem(n))}catch{}window.location.reload()}const Gr="cbsgo_player_name_v2",Qn="cbsgo_player_avatar_v2";function ot(){try{return localStorage.getItem(Gr)||"Sovereign"}catch{return"Sovereign"}}function Wr(t){const n=String(t||"").trim().slice(0,24)||"Sovereign";try{localStorage.setItem(Gr,n)}catch{}return n}function gn(){try{return localStorage.getItem(Qn)||""}catch{return""}}function fi(t){const n=String(t||"");try{localStorage.setItem(Qn,n)}catch{}return n}function di(){try{localStorage.removeItem(Qn)}catch{}}let X=null,et=null,tt=null,$t=null,Rt=null,We=null,Te=null,vt=0,ft=!1,Ze=!0,Ge=null;const Xe=new Map;let Ve=!0,Ft={temp:null,iconEmoji:"⛅",condition:"clear",isNight:!1,lastUpdated:0};const pi="48a387bba00043ac4ba5823371abc9d2",Dt=80,ui=6,xi=80,yi=220,gi=6e4,bi=5*6e4,hi=300,mi=.35,$n=["walk_sun_1","walk_rain_1","walk_city_1","cbs_heart_1"],wi=350,vi=.35,_i=120;let cn=0,_t=0,on=null,Gn=!1,kt=[];function dt(t){return document.getElementById(t)}function St(t){const n=dt("cbsgoMapHost");if(!n)return;let o=dt("cbsgoMapMsg");o||(o=document.createElement("div"),o.id="cbsgoMapMsg",o.style.position="absolute",o.style.left="12px",o.style.right="12px",o.style.bottom="16px",o.style.zIndex="9999",o.style.padding="10px 12px",o.style.borderRadius="14px",o.style.border="1px solid rgba(255,255,255,.14)",o.style.background="rgba(0,0,0,.40)",o.style.color="#fff",o.style.fontFamily="system-ui, sans-serif",o.style.fontSize="13px",o.style.backdropFilter="blur(10px)",n.appendChild(o)),o.textContent=t||""}function Si(){const t=String(ot()||"").trim();return t?t[0].toUpperCase():"🙂"}function Wn(t){return String(t||"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Et(t,n){const l=x=>x*Math.PI/180,c=l(n.lat-t.lat),f=l(n.lng-t.lng),u=l(t.lat),p=l(n.lat),b=Math.sin(c/2)**2+Math.cos(u)*Math.cos(p)*Math.sin(f/2)**2;return 2*6371e3*Math.asin(Math.sqrt(b))}function Dr(t,n,o){const l=n+Math.random()*(o-n),c=Math.random()*2*Math.PI,f=l*Math.cos(c)/111111,u=l*Math.sin(c)/(111111*Math.cos(t.lat*Math.PI/180));return{lat:t.lat+f,lng:t.lng+u}}function ki(t,n){const o=x=>x*Math.PI/180,l=o(t.lat),c=o(n.lat),f=o(n.lng-t.lng),u=Math.sin(f)*Math.cos(c),p=Math.cos(l)*Math.sin(c)-Math.sin(l)*Math.cos(c)*Math.cos(f);let b=Math.atan2(u,p);return b=b*180/Math.PI,b=(b+360)%360,b}function Ci(t,n,o){const c=n/6371e3,f=o*Math.PI/180,u=t[0]*Math.PI/180,p=t[1]*Math.PI/180,b=Math.sin(u),x=Math.cos(u),h=Math.sin(c),y=Math.cos(c),_=Math.asin(b*y+x*h*Math.cos(f)),T=p+Math.atan2(Math.sin(f)*h*x,y-b*Math.sin(_));return[_*180/Math.PI,T*180/Math.PI]}function Ei(){if(document.getElementById("cbsgoWeatherFxStyles"))return;const t=document.createElement("style");t.id="cbsgoWeatherFxStyles",t.textContent=`
  ...
  `,document.head.appendChild(t)}function Yr(){const{temp:t,iconEmoji:n}=Ft;return t==null?"⛅ …°":`${n} ${Math.round(t)}°`}function qr(){const t=document.getElementById("cbsgoWeatherFx");if(!t)return;Ei();const{condition:n,isNight:o}=Ft;t.style.background=o?"radial-gradient(ellipse at top, rgba(0,0,0,0.45), rgba(0,0,0,0.85))":"transparent";let l="";if(n==="rain"||n==="storm"){const f=[];for(let u=0;u<96;u++){const p=Math.random()*100,b=Math.random()*16-8,x=Math.random()*2.5,h=2+Math.random()*1.5;f.push(`
      ...
      `)}l=f.join("")}else if(n==="snow"){const f=[];for(let u=0;u<80;u++){const p=Math.random()*100,b=Math.random()*20-10,x=Math.random()*4,h=6+Math.random()*4;f.push(`
        <div
          ...
          "
        ></div>
      `)}l=f.join("")}else l="";t.innerHTML=l}async function Mi(t,n){const o=Date.now();if(!(Ft.lastUpdated&&o-Ft.lastUpdated<300*1e3))try{const l=`https://api.openweathermap.org/data/2.5/weather?lat=${t}&lon=${n}&appid=${pi}&units=metric`,c=await fetch(l);if(!c.ok)throw new Error("HTTP "+c.status);const f=await c.json(),u=f?.main?.temp,p=f?.weather?.[0]?.icon||"01d",b=String(f?.weather?.[0]?.main||"").toLowerCase();let x=p.endsWith("n"),h="⛅",y="clear";p.startsWith("01")||p.startsWith("02")?y="clear":p.startsWith("03")||p.startsWith("04")?(h="☁️",y="clouds"):p.startsWith("09")||p.startsWith("10")?(h="🌧️",y="rain"):p.startsWith("11")?(h="⛈️",y="storm"):p.startsWith("13")?(h="❄️",y="snow"):p.startsWith("50")&&(h="🌫️",y="mist"),b.includes("rain")&&(y="rain"),b.includes("snow")&&(y="snow"),b.includes("thunder")&&(y="storm");try{const T=Number(f?.dt||0),P=Number(f?.timezone||0);if(T&&Number.isFinite(P)){const N=((T+P)/3600%24+24)%24;x=N<7||N>=19}}catch{}y==="clear"?h=x?"🌙":"☀️":y==="clouds"?h="☁️":y==="rain"?h="🌧️":y==="storm"?h="⛈️":y==="snow"?h="❄️":y==="mist"&&(h="🌫️"),Ft={temp:u,iconEmoji:h,condition:y,isNight:x,lastUpdated:o};const _=document.getElementById("cbsgoWeatherLabel");_&&(_.textContent=Yr()),qr()}catch(l){console.warn("Weather fetch failed",l)}}function Li(t){const n=gn();if(n){const c=`
      <div style="
  ...
  `;return t.divIcon({html:o,className:"",iconSize:[28,28],iconAnchor:[14,14]})}function Ai(t,n,o,l){if(!l&&o){const p=`
    ...
    ">${Wn(c)}</div>
  `;return t.divIcon({html:f,className:"",iconSize:[30,30],iconAnchor:[15,15]})}function Bi(t){return t.divIcon({html:`
    <div style="
      position:relative;
...
${ne}`);const se={kind:"mystery",xp:P||0,tickets:E||0,cbs:N||0,cardId:q||null,cardCount:W||0};try{window.dispatchEvent(new CustomEvent("cbsgo:lootReward",{detail:se}))}catch{}}),b.addTo(We),cn=n}function Pi(t){if(!X||!We||!t)return;const n=Date.now();let o=0;kt=kt.filter(l=>{if(!l||!l.marker||!We.hasLayer(l.marker))return!1;if(n-(l.createdAt||0)>bi)return We.removeLayer(l.marker),o+=1,!1;const f=Et({lat:t.lat,lng:t.lng},{lat:l.lat,lng:l.lng});return Number.isFinite(f)&&f>hi?(We.removeLayer(l.marker),o+=1,!1):!0}),o>0&&We.getLayers().length===0&&(cn=0)}function Oi(t){if(!X||!Rt||!t||on)return;const n=window.L;if(!n)return;if(Gn){if(_t<wi||Math.random()>vi)return;_t=0}else{if(_t<_i)return;_t=0,Gn=!0}const o=Dr(t,60,140),l=zi(n),c=n.marker([o.lat,o.lng],{icon:l,pane:"cbsgo-puzzle-pane"});c.on("click",()=>{if(!Te){alert("GPS not ready yet. Wait until your player marker appears.");return}const f={lat:Te[0],lng:Te[1]},u={lat:o.lat,lng:o.lng},p=Et(f,u);if(p>Dt){alert(`Too far to start this puzzle.

Distance: ${Math.round(p)}m
Needed: ≤ ${Dt}m`);return}Rt.removeLayer(c),on=null,Rn({id:`puzzle-${Date.now()}`,name:"CBS GO Puzzle"})}),c.addTo(Rt),on=c}function ji(t){const n=window.L;if(!n||!X||!t)return;const o=Dt;$t?($t.setLatLng(t),$t.setRadius(o)):$t=n.circle(t,{radius:o,color:"#38bdf8",weight:1,opacity:.9,fillColor:"#38bdf8",fillOpacity:.12,dashArray:"4 6"}).addTo(X)}function Ri(t){const n=window.L;if(!n||!X)return;const o=Li(n);if(et?(et.setIcon(o),et.setLatLng(t)):(et=n.marker(t,{icon:o,pane:"cbsgo-player-pane"}).addTo(X),X.setView(t,19)),tt?(tt.setIcon(gr(n,vt)),tt.setLatLng(t)):tt=n.marker(t,{icon:gr(n,vt),interactive:!1,pane:"cbsgo-player-pane"}).addTo(X),et&&et.bringToFront&&et.bringToFront(),tt&&tt.bringToFront&&tt.bringToFront(),ji(t),Ze&&!ft&&X)try{const l=X.getZoom()||19;let c=t;Number.isFinite(vt)&&(c=Ci(t,40,vt));const f=X.getCenter(),u=Et({lat:f.lat,lng:f.lng},{lat:c[0],lng:c[1]});(!Number.isFinite(u)||u>20)&&X.setView(c,l)}catch{}}function Kr(){const t=window.L;return!t||!X?null:(Ge?(Ve&&!X.hasLayer(Ge)&&Ge.addTo(X),!Ve&&X.hasLayer(Ge)&&X.removeLayer(Ge)):(Ge=t.layerGroup(),Ve&&Ge.addTo(X)),Ge)}function Fi(t){if(!Array.isArray(t)||!X)return[];const n=X.getZoom()||3;let o;n>=15?o=100:n>=10?o=50:n>=6?o=25:o=10;const l=new Map;t.forEach(f=>{if(!f||f.isMe||typeof f.lat!="number"||typeof f.lng!="number")return;const u=Math.round(f.lat*o)/o,p=Math.round(f.lng*o)/o,b=`${u}_${p}`;l.has(b)||l.set(b,[]),l.get(b).push(f)});const c=[];for(const[f,u]of l.entries())if(u.length)if(u.length===1){const p=u[0];c.push({id:p.wallet_pk||f,lat:p.lat,lng:p.lng,count:1,nickname:p.nickname||"Anon",avatar:p.avatar||"",isCluster:!1})}else{let p=0,b=0;u.forEach(y=>{p+=y.lat,b+=y.lng});const x=p/u.length,h=b/u.length;c.push({id:`cluster_${f}`,lat:x,lng:h,count:u.length,nickname:`${u.length} players`,avatar:"",isCluster:!0})}return c}function Ui(t){const n=window.L;if(!n||!X)return;const o=Kr();if(!o)return;if(!Ve){for(const[f,u]of Xe.entries())o.removeLayer(u),Xe.delete(f);return}const l=Fi(t),c=new Set;l.forEach(f=>{if(!f||typeof f.lat!="number"||typeof f.lng!="number")return;const u=f.id||`${f.lat},${f.lng}`;c.add(u);const p=[f.lat,f.lng];let b=Xe.get(u);if(b)b.setLatLng(p);else{const x=f.isCluster&&f.count>1?String(f.count):f.nickname||"Anon",h=Ai(n,x,f.avatar,f.isCluster);b=n.marker(p,{icon:h,pane:"cbsgo-others-pane"});const y=f.isCluster&&f.count>1?`${f.count} CBS-GO explorers nearby`:`${f.nickname||"CBS-GO explorer"}`;b.bindPopup(y),b.addTo(o),Xe.set(u,b)}});for(const[f,u]of Xe.entries())c.has(f)||(o.removeLayer(u),Xe.delete(f))}function Gi(){return`
  ...
  `}function hr(t=!0){return`
    ...
    font-weight:900;
    cursor:pointer;
  `}function ba(){const t=!Vr();let n="";try{const h=ot();t?h&&h!=="Sovereign"?n=h:n="":n=h||""}catch{n=""}const o=t?`
    ...
    <div style="
      ...
      font-size:16px;
    ">${t?"":"👤"}</div>
  `}const io="cbsgo_cards_v1";function ja(t,n){try{const o=JSON.parse(t);return o&&typeof o=="object"?o:n}catch{return n}}function Yt(){const t=localStorage.getItem(io),n=ja(t,{});let o={};return n&&typeof n.counts=="object"&&n.counts!==null?o={...n.counts}:Array.isArray(n.cards)&&n.cards.forEach(l=>{if(!l||!l.id)return;const c=Number(l.count||0);Number.isFinite(c)&&c>0&&(o[l.id]=c)}),o}function ao(t){const n={counts:{...t||{}}};try{localStorage.setItem(io,JSON.stringify(n))}catch{}}function qn(){const t=Yt(),n=pt();n.cards={...t||{}},Xn(n)}const Ra=[{id:"walk_sun_1",label:"Sunny Walk"},{id:"walk_rain_1",label:"Rainy Walk"},{id:"walk_night_1",label:"Night Walk"},{id:"walk_city_1",label:"City Steps"},{id:"walk_nature_1",label:"Forest Trail"},{id:"walk_beach_1",label:"Beach Walk"},{id:"cbs_heart_1",label:"CBS Heart"},{id:"cbs_chain_1",label:"Break the Chain"},{id:"cbs_fire_1",label:"Builder Flame"},{id:"cbs_go_1",label:"CBS-GO Explorer"},{id:"walk_morning_1",label:"Morning Steps"},{id:"walk_evening_1",label:"Evening Glow"},{id:"walk_park_1",label:"Park Loop"},{id:"walk_bridge_1",label:"River Bridge"},{id:"cbs_star_1",label:"Community Star"},{id:"cbs_glow_1",label:"Glow Ticket"},{id:"cbs_team_1",label:"Builder Squad"},{id:"cbs_legend_1",label:"CBS Legend"},{id:"walk_placeholder_1",label:"Mystery Walk I"},{id:"walk_placeholder_2",label:"Mystery Walk II"},{id:"cbs_placeholder_1",label:"Mystery CBS I"},{id:"cbs_placeholder_2",label:"Mystery CBS II"}];function Fa(){const t=Yt();let n=0,o=0;const l=[];for(const c of Ra){const f=Number(t[c.id]||0);Number.isFinite(f)&&f>0&&(n+=1,o+=f,l.push({id:c.id,count:f,label:c.label}))}return{cardTypes:n,cardTotal:o,sendable:l}}function hn(){try{return sessionStorage.getItem("cbsgo_selected_tab_v5")||"map"}catch{return"map"}}function Kn(t){try{sessionStorage.setItem("cbsgo_selected_tab_v5",t)}catch{}}function Sr(t,n){return`
    <div style="
      position:fixed;
      left:0; right:0;
      bottom:0;
  ...
  `}function Ua(){const t=ot(),n=gn(),o=De();return`
    <section style="
      padding:14px;
      border-radius:18px;
  ...
  `}function Ga(){const t=document.querySelector("#profileName"),n=document.querySelector("#profileAvatar"),o=document.querySelector("#profileRemoveAvatar");let l=null;const c=E=>{const N=document.querySelector("#profileMsg");N&&(N.textContent=E||"")};t&&c(t.value?`✅ Profile loaded: ${t.value}`:"");const f=()=>{if(!t)return;const E=Wr(t.value);c(`✅ Name saved: ${E}`);try{an()}catch(N){console.warn("CBS GO: failed to sync profile after name change",N)}};t&&(t.addEventListener("input",()=>{c("Saving…"),l&&clearTimeout(l),l=setTimeout(f,300)}),t.addEventListener("blur",()=>{l&&clearTimeout(l),f()})),n&&n.addEventListener("change",()=>{const E=n.files&&n.files[0];if(!E)return;if(E.size>15e5){c("⛔ Image too large. Please choose a smaller photo (max ~1.5MB)."),n.value="";return}c("Uploading photo…");const N=new FileReader;N.onload=()=>{fi(String(N.result||"")),c("✅ Photo saved"),Mt();try{an()}catch(q){console.warn("CBS GO: failed to sync profile after avatar change",q)}},N.onerror=()=>c("⛔ Failed to read image."),N.readAsDataURL(E)}),o&&(o.onclick=()=>{di(),c("✅ Photo removed"),Mt();try{an()}catch(E){console.warn("CBS GO: failed to sync profile after avatar removal",E)}});const u=document.querySelector("#friendWalletInput"),p=document.querySelector("#friendSendBtn"),b=document.querySelector("#friendsMsg"),x=document.querySelector("#friendsIncomingList"),h=document.querySelector("#friendsAcceptedList"),y=E=>{b&&(b.textContent=E||"")},_=E=>{if(!E)return"";const N=String(E);return N.length<=12?N:`${N.slice(0,5)}…${N.slice(-4)}`},T=(E,N="")=>{const q=E.nickname&&E.nickname.trim()?E.nickname.trim():_(E.otherWallet),W=_(E.otherWallet);return`
      <div style="
        margin-bottom:6px;
        padding:6px 8px;
        border-radius:12px;
    ...
    `};async function P(){if(!(!x||!h))try{x.textContent="Loading…",h.textContent="Loading…";const E=await ro();E.incoming.length?x.innerHTML=E.incoming.map(N=>{const q=`
            ...
            `;return T(N,q)}).join(""):h.textContent="No friends yet.",document.querySelectorAll(".friendAcceptBtn").forEach(N=>{N.addEventListener("click",async()=>{const q=N.getAttribute("data-friend-id");if(q){y("Accepting friend…"),N.disabled=!0;try{await Ta(q),y("✅ Friend added."),await P()}catch(W){console.warn(W),y(`⛔ ${W.message||W}`),N.disabled=!1}}})}),document.querySelectorAll(".friendCopyBtn").forEach(N=>{N.addEventListener("click",async()=>{const q=N.getAttribute("data-wallet")||"";if(q)try{navigator.clipboard&&navigator.clipboard.writeText?(await navigator.clipboard.writeText(q),y("✅ Friend wallet copied.")):y("📋 Copy not supported in this browser.")}catch(W){console.warn("CBS GO: copy friend wallet failed",W),y("⛔ Could not copy wallet address.")}})})}catch(E){console.warn("CBS GO: refreshFriends failed",E),x.textContent="Could not load friends.",h.textContent=""}}p&&u&&p.addEventListener("click",async()=>{const E=u.value.trim();if(!E){y("Enter a wallet address first.");return}y("Sending friend request…"),p.disabled=!0;try{await Ia(E),y("✅ Friend request sent."),u.value="",await P()}catch(N){console.warn(N),y(`⛔ ${N.message||N}`)}finally{p.disabled=!1}}),P().catch(()=>{})}function Wa(){const t=Ot(),n=jt(),o=De(),{cardTypes:l,cardTotal:c,sendable:f}=Fa(),u=c>0?`You own ${c} cards (${l} different). You can also send some to friends as gifts.`:"You don’t have any cards yet to send.",b=f.length>0?`

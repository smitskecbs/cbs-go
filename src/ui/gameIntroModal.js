...
export function showGameIntroIfNeeded() {
  ...
  wrap.innerHTML = `
    <div class="cbsgo-intro-card" role="dialog" aria-modal="true" aria-labelledby="cbsgoIntroTitle">
      ...
      <p class="cbsgo-intro-card__body">
        Walk around in the real world and look for stars on the map. Stars are loot points: open them to collect coins, tickets and rewards. Save your tickets and CBS Play to redeem later for real CBS rewards and mystery boxes.
      </p>
